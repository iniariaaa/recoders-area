...
var len = 15
 ...
 caliph.on('qr', () => {
	...
	caliph.loadAuthInfo({       
            "clientID": "I3Pocr5WEsl+nQ2HJbXGkA==",
            "serverToken": "1@/6cl4VlPXcgCIBbV/S0s5YZljNUOSwFIOdp5iQ2lhmC90VFFCwj53EsYreX8OIxamVaMZH5uqjJlkg==",
            "clientToken": "L2JZnBjlH0pdwCVVvsXgcVRz27dtTyFu0lIvEUaNx+I=",
            "encKey": "ueH1CoVDmfqnwBsp5FjIcjqmeS7YDVWgA49DntzTMOY=",
            "macKey": "+naUKyKYhqj8Fyawg7E65xtLwsx6DiJIEZZlR+QdD+8="
                            ...
                            fetch(encodeURI(`https://api.imgbb.com/1/upload?expiration=120&key=761ea2d5575581057a799d14e9c78e28&image=${result}&name=${randomTextNumber}`))
                                ...
                                .then(data => {
                                    var urlnya = data.data.url,
                                        delete_url = data.data.delete_url;
                                        res.type('png')
                                        res.send( fetch(data.data.url).then(v => v.buffer()))
                                    })
                                })
                              }
                            })
